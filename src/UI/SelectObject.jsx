...
function SelectObject({nodeId}) {
    ...
    return (
        <div className='relative w-full h-full flex flex-col justify-center items-center rouded-xl overflow-hidden bg-red'>
            {
                objects &&
                    Object.keys(objects).length == 0 ?
                    <p className='relative w-full text-white text-center text-lg py-4'>No Objects To Show</p>
                    :
